...
frontend_endpoint = urlparse(os.getenv("TENZIR_PLATFORM_DOMAIN")).hostname
...
write_certificate([frontend_endpoint, "app", "localhost"], filename="ssl/frontend-cert.pem")
...
# Postgres is particularly picky 
os.chmod("ssl/db-cert.pem", 0o600)
os.chown("ssl/db-cert.pem", 999, 999)