...
- `tenzir/tenzir:v5.1` to use the latest version of a specific minor release.
- `tenzir/tenzir:v5` to use the latest version of a specific major release.
  `tenzir/tenzir:v4.11.2` to use the specified release.- `tenzir/tenzir:latest` to use the latest release.
